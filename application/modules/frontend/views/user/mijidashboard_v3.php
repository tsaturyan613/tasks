                                           ...
                                           exit();*/
                                            foreach ($all_order as $key => $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>  <?php echo $getOrderDetailsByOrderId['tot_used_cup'] ?></td>
                                                    <td>  <?php echo $getOrderDetailsByOrderId['tot_lost_cup'] ?></td>
                                                    <td><?php echo number_format($total_percent_loss, 2, ',', ''); ?> %</td>
                                                </tr>
                                                <?php
                                                
                                                
                                                $user_ids[$row->event_name][]=round($total_percent_loss, 2);
                                            }
//                                            $user_ids= array_unique($city_ids);
//                                            print_R($city_ids);
                                            
                                            foreach ($user_ids as $k=>$rw){
//                                                echo $k;
//                                                print_R($rw);
//                                                array_sum($rw);
                                                $d= floatval(0);
...
//                                                echo floatval($d/count($rw)).'-';
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: [<?php echo implode($event_name, ','); ?>],
                    datasets: [{
