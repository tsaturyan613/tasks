                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <table id="table_id123" class="table table-striped table-inbox big-table mb-0">
                                        <thead>
                                            <tr>
                                                <th>Status</th>
                                                <th>Datum</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($ord_items->result() as $row) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->cups_per_visitor ?></td>
                                                    <td><?php if ($row->invoice_created_by_admin == '1') { ?>
                                                            <a class="common-links"  href="<?php echo base_url(); ?>user/citynewinvoice/<?php echo $row->id ?>">Factuur
                                                                <!--<i class="fas fa-angle-right"></i>-->
                                                            </a>
                                                        <?php } ?></td>
                                                    <td><a class="common-links"  href="<?php echo base_url(); ?>user/cityinvoice/<?php echo $row->id ?>">Orderbevestiging </a></td>
                                                </tr>
                                            <?php } 
                                            }else{ ?>
                                                 <tr>
