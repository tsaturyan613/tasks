                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered">
                                    <div class="portlet-title">
                                        <div class="caption"> <i class="icon-settings font-red"></i> <span class="caption-subject font-red sbold uppercase"> Edit Supercity</span> </div>
                                    </div>
                                    <div class="portlet-body">
                                        <form action="<?php echo base_url(); ?>admin/gemeenten_management/update_supercity" id="myFrm" method="post" class="horizontal-form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                     <div class="col-md-6">
                                                        <div class="form-group"> <label class="control-label">Naam</label> <input type="text" required="" name="city_name" id="city_name" value="<?php echo $query['city_name']; ?>" class="form-control" placeholder="Naam"> <label for="city_name" class="error" style="color:red; display:none;"></label> </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group"> <label class="control-label">E-mail</label> <input type="email" required="" name="login_email" value="<?php echo $query['email']; ?>"  id="login_email" class="form-control" placeholder="E-mail"> <label for="login_email" class="error" style="color:red; display:none;"></label> </div>
                                                    </div>
                                                    <div class="col-md-6">
