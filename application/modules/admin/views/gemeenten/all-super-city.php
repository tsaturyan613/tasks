                ...
                <div class="page-content">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="pull-right "> <a href="<?php echo base_url(); ?>admin/gemeenten_management/add_supercity" class="btn btn-success">Add Super City</a> <br></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-globe"></i>Super City (
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <a title="Edit" href="<?php echo base_url(); ?>admin/gemeenten_management/all_city_by_supercity/<?php echo $row->u_id; ?>" class="btn-sm btn-success rounded-corner btn-share">All Cities</a> 
						    <a title="Edit" href="<?php echo base_url(); ?>admin/gemeenten_management/edit_supercity/<?php echo $row->u_id; ?>" class="btn-sm btn-success rounded-corner btn-share">Edit</a> 
                                                    <a title="Delete" onClick="return confirm('Would you like to delete this ?');" href="<?php echo base_url(); ?>admin/gemeenten_management/delete_supercity/<?php echo $row->u_id; ?>" class="btn-sm btn-danger rounded-corner btn-share">Delete</a>
