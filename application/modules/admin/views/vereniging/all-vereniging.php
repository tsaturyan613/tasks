                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <span>Vereniging List</span> </li>
                        </ul>
                    </div><br>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right "> <a href="<?php echo base_url(); ?>admin/vereniging_management/add_vereniging" class="btn btn-success">Add Vereniging </a> <br></div>
                        </div>
                        <div class="col-md-12">
                            <div id="msg_div">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-globe"></i>Vereniging list (
						...
						<td>
                                                ...
                                                <td> 
						    <a title="Edit" href="<?php echo base_url(); ?>admin/vereniging_management/edit_vereniging/<?php echo $row->u_id; ?>" class="btn-sm btn-success rounded-corner btn-share">Edit</a> 
                                                    <a title="Delete" onClick="return confirm('Would you like to delete this ?');" href="<?php echo base_url(); ?>admin/vereniging_management/delete_vereniging/<?php echo $row->u_id; ?>" class="btn-sm btn-danger rounded-corner btn-share">Delete</a> 
						</td>
                                            </tr>
                                            <?php $i++;}}else{?>
                                            <tr>
