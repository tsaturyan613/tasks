                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $query['happy_clients']; ?>" name="happy_clients" id="happy_clients"  class="form-control" placeholder="">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $query['awards']; ?>" name="awards" id="awards"  class="form-control" placeholder="">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $query['employees']; ?>" name="employees" id="employees"  class="form-control" placeholder="">
...
<!--                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $query['testimonial_heading']; ?>" name="testimonial_heading" id="testimonial_heading"  class="form-control" placeholder="">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $query['testimonial_author']; ?>" name="testimonial_author" id="testimonial_author"  class="form-control" placeholder="">
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label"><?php echo str_replace("_", " ", 'section_3_image'); ?></label>
                                                            <input type="file" name="section_3_image" id="section_3_image"  class="form-control" placeholder="">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label">  </label>
                                                            <img src="<?php echo base_url(); ?>uploads/cms/<?php echo $query['section_3_image']; ?>" width="100px" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="control-label"><?php echo str_replace("_", " ", 'section_3_heading'); ?></label>
                                                            <input type="text" value="<?php echo $query['section_3_heading']; ?>" name="section_3_heading" id="section_3_heading"  class="form-control" placeholder="">

                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="control-label"><?php echo str_replace("_", " ", 'section_3_content'); ?></label>
                                                            <textarea name="section_3_content" id="section_3_content"  class="form-control" ><?php echo $query['section_3_content']; ?></textarea>
                                                        </div>
                                                    </div>
