        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <!--<div class="pull-right "> <a href="<?php echo base_url(); ?>admin/cms_management/add_menu" class="btn btn-success">Add Menu </a> <br></div>-->
                        </div>
                        <div class="col-md-12">
                            <div id="msg_div">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-globe"></i>Menu list (
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
						    <a title="Edit" href="<?php echo base_url(); ?>admin/cms_management/edit_menu/<?php echo $row->id; ?>" class="btn-sm btn-success rounded-corner btn-share">Edit</a> 
