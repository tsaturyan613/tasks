...
<!--                                            <pre> <?php
                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="content_image_old[]"  value="<?php echo $content->content_image[$i] ?>"">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label">  </label>
                                                                <img src="<?php echo base_url(); ?>uploads/cms/<?php echo $content->content_image[$i] ?>" width="100px" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="control-label"><?php echo str_replace("_", " ", 'content_heading'); ?></label>
                                                                <input type="text" value="<?php echo $content->content_heading[$i] ?>" name="content_heading[]" id=""  class="form-control" placeholder="">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="content_text[]" id=""  class="form-control" ><?php echo $content->content_text[$i] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                ...
                                                <div><button id="addContent" type="button" class="btn green"> <i class="fa fa-plus"></i>Add More</button> </div>
