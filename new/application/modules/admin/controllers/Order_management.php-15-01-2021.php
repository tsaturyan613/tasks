                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <tr>
                                                        <td style="line-height: 28px;">Cliënt</td>
                                                        ...
                                                        <div class="box-cards"> 
                                                            <div class="row">
                                                                            ...
                                                                            <div class="">
                                                                                <div class="left-table">
                                                                                    ...
                                                                                    <div class="raaddress">
                                                                                        ...
                                                                                        <p>Street : '. $getUserDetails['usertupe'] == 'City' ? $getUserDetails['street'] : $ord_stng['street'] .'</p>
                                                                                        <p>Email : '. $getUserDetails['email'] .'</p>
                                                                                        <h4>Bestelling: '.  sprintf("%02d", $ord_stng['id']) .'</h4>
                                                                                        <h4>Datum Event: </h4><p>'.  date(('d-m-Y'), strtotime($ord_stng['event_start_date'])) . ' ' . $ord_stng['event_start_time'] . ' to ' . date(('d-m-Y'), strtotime($ord_stng['event_end_date'])) . ' ' . $ord_stng['event_end_time'].'</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>	
                                                                        </td>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-striped table-inbox print-page mb-0" style=" width: 100%;">
                                                                        <thead>
                                                                            <tr>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="text-align: center;">'. date('Y').'/17'. sprintf("%02d", $ord_stng['id']) .'</td>
                                                                                <td style="text-align: center;">'.  date(('d/m/Y'), strtotime($ord_stng['created_at'])) .'</td>
                                                                                <td style="text-align: center;"></td>
                                                                                <td style="text-align: center;">'.  date(('d/m/Y'), strtotime($ord_stng['created_at'] . " +30 days")).'</td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                                    ...
                                                                    <table class="table table-striped table-inbox print-page mb-0" style="width:100%;">
                                                                        ...
                                                                        <tbody>';
                                                                            ...
                                                                            foreach ($ord_items->result() as $row) {
                                                                              ...
                                                                              $html1 .='  <tr>
                                                                                    <td>'.  $row->name.'</td>
                                                                                    <td> &#8364; '.  number_format((float) $row->order_time_max_rental_cost_per_product, 2, ',', '').'</td>
                                                                                    <td>&#8364; '.  number_format((float) $row->order_time_max_wash_cost_per_product, 2, ',', '').'</td>
                                                                                    <td>&#8364; '.  number_format((float) $row->order_time_max_lost_cost_per_product, 2, ',', '').' </td>
                                                                                    <td>'.  $row->used_cups.' </td>
                                                                                    <td>'.  $row->lost_cup.' </td> 
                                                                                    <td>&#8364;'.number_format(floatval(($row->order_time_max_rental_cost_per_product * $row->used_cups) + ($row->used_cups * $row->order_time_max_wash_cost_per_product ) + ($row->lost_cup * $row->loss_prc )), 2, ',', '')
                                                                                        .'
                                                                                            </td>
                                                                                </tr>';
                                                                ...
                                                                <div class="right-table row">
                                                                    <div style="width: 30%; margin-left: 70%;">
                                                                        ...
                                                                        <table class="normal-table table mb-2" style="width: 90%;">';
                                                                            if ($ord_stng['collection_by_profiwash_at_the_event'] != '') {
                                                                               $html1 .='  <tr>
                                                                                    <td><strong>Levering op evenement</strong></td>
                                                                                    <td>&#8364; '.
                                                                                         number_format((float) $ord_stng['collection_by_profiwash_at_the_event'], 2, ',', '').' </td>
                                                                                </tr>';
                                                                               $s_tot += floatval($ord_stng['collection_by_profiwash_at_the_event']);
                                                                             }
                                                                             if ($ord_stng['return_to_address'] != '') { 
                                                                                $html1 .='<tr>
                                                                                    ...
                                                                                    <td>&#8364; '. number_format((float) $ord_stng['return_to_address'], 2, ',', '').'</td>
                                                                                </tr>';
                                                                                         $s_tot += floatval($ord_stng['return_to_address']);
                                                                             } 
                                                                           if ($ord_stng['collection_by_profiwash_at_collection_point'] != '') { 
                                                                               $html1 .=' <tr>
                                                                                    ...
                                                                                    <td >&#8364; '.number_format((float) $ord_stng['collection_by_profiwash_at_collection_point'], 2, ',', '').'</td>
                                                                                </tr>';
                                                                                        $s_tot += floatval($ord_stng['collection_by_profiwash_at_collection_point']);
                                                                             } 
                                                                          if ($ord_stng['return_via_collection_point'] != '') {
                                                                               $html1 .=' <tr>
                                                                                    ...
                                                                                    <td >&#8364; '.number_format((float) $ord_stng['return_via_collection_point'], 2, ',', '').'</td> </tr>';
                                                                                        $s_tot += floatval($ord_stng['return_via_collection_point']);
                                                                           ...
                                                                           if ($ord_stng['delivery_to_profiwash'] != '') { 
                                                                               $html1 .=' <tr>
                                                                                    ...
                                                                                    <td >&#8364;'.number_format((float) $ord_stng['delivery_to_profiwash'], 2, ',', '').'</td>
                                                                                </tr>';
                                                                                        $s_tot += floatval($ord_stng['delivery_to_profiwash']);
                                                                             } 
                                                                            if ($ord_stng['pick_up_at_profiwash'] != '') { 
                                                                                $html1 .='<tr>
                                                                                    ...
                                                                                    <td >&#8364;'.number_format((float) $ord_stng['pick_up_at_profiwash'], 2, ',', '').'</td>
                                                                                </tr>';
                                                                                        $s_tot += floatval($ord_stng['pick_up_at_profiwash']);
                                                                             }
                                                                            $html1 .='<tr>
                                                                                <td>Subtotaal</td>
                                                                                <td>&#8364; '.  number_format((float) $s_tot, 2, ',', '').'</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>BTW 21%</td>
                                                                                <td>&#8364; '.  number_format(floatval((21 / 100) * $s_tot), 2, ',', '').'</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Totaal</td> 
                                                                                <td>&#8364; '.  number_format(floatval($s_tot + ((21 / 100) * $s_tot)), 2, ',', '').'</td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                </div>
...
//        $query = $this->db->get();
//        $data['ord_items'] = $query;
//        $html=$this->load->view('event/invoice', $data);
