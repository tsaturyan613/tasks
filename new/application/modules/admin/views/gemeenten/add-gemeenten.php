                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered">
                                    <div class="portlet-title">
                                        <div class="caption"> <i class="icon-settings font-red"></i> <span class="caption-subject font-red sbold uppercase"> Add Gemeenten</span> </div>
                                    </div>
                                    <div class="portlet-body">
                                        <form action="<?php echo base_url(); ?>admin/gemeenten_management/save_gemeenten" id="myFrm" method="post" class="horizontal-form" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group"> <label class="control-label">Land</label> <input type="text" required="" name="country" id="country" class="form-control" placeholder="Land"> <label for="country" class="error" style="color:red; display:none;"></label> </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group"> <label class="control-label">Postcode</label> <input type="text" required="" name="post_code" id="post_code" class="form-control" placeholder="Postcode"> <label for="post_code" class="error" style="color:red; display:none;"></label> </div>
                                                    </div>
                                                </div>
<!--                                                <div class="row">
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group"> <label class="control-label">Login Email</label> <input type="text"  name="login_email" id="login_email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Stad"> <label for="login_email" class="error" style="color:red; display:none;"></label> </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group"> <label class="control-label">Password</label> <input type="password"  name="login_password" id="txtPassword" class="form-control" placeholder="Postcode"> <label for="txtPassword" class="error" style="color:red; display:none;"></label> </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group"> <label class="control-label">Confirm Password</label> <input type="password"   id="txtConfirmPassword" class="form-control" placeholder="Confirm Password"> <label for="txtConfirmPassword" class="error" style="color:red; display:none;"></label> </div>
                                                    </div>
                                                </div>
