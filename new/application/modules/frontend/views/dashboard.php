                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase">Total Sales   </span>
                                            <span class="caption-helper">all cities & turnover per month in EUR</span>
                                        </div>
                                        <div class="actions">
                                    ...
                                    <div class="portlet-body">
                                        <div id="site_statistics_loading">
                                            <img src="<?php echo base_url(); ?>assets/admin/global/img/loading.gif" alt="loading" /> </div>
                            ...
                            <div class="col-lg-6 col-xs-12 col-sm-12">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="icon-share font-red-sunglo hide"></i>
                                            <span class="caption-subject font-dark bold uppercase">Total Turnover ( Per Month)   </span>
                            ...
                            <div class="col-lg-6 col-xs-12 col-sm-12">
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="icon-share font-red-sunglo hide"></i>
                                            <span class="caption-subject font-dark bold uppercase">Product Wise Total Turnover ( Per Month)   </span>
                                            <!--<span class="caption-helper">all cities & turnover per product in EUR</span>-->
                                        </div>
                                        <div id="container" >
                                                                                                ...
                                                                                                <div class="mt-comments">
                                                                                                    <div class="mt-comment">
                                                                                                        <div class="mt-comment-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar1.jpg" /> </div>
                                                                                                    ...
                                                                                                    <div class="mt-comment">
                                                                                                        <div class="mt-comment-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar6.jpg" /> </div>
                                                                                                        <div class="mt-comment-body">
                                                                                                            <div class="mt-comment-info">
                                                                                                    ...
                                                                                                    <div class="mt-comment">
                                                                                                        <div class="mt-comment-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar8.jpg" /> </div>
                                                                                                        <div class="mt-comment-body">
                                                                                                            <div class="mt-comment-info">
                                                                                                    ...
                                                                                                    <div class="mt-comment">
                                                                                                        <div class="mt-comment-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar4.jpg" /> </div>
                                                                                                        <div class="mt-comment-body">
                                                                                                            <div class="mt-comment-info">
                                                                                        ...
                                                                                        <div class="tab-content">
                                                                                                ...
                                                                                                <div class="mt-actions">
                                                                                                    <div class="mt-action">
                                                                                                        <div class="mt-action-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar10.jpg" /> </div>
                                                                                                    ...
                                                                                                    <div class="mt-action">
                                                                                                        <div class="mt-action-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar3.jpg" /> </div>
                                                                                                        <div class="mt-action-body">
                                                                                                            <div class="mt-action-row">
                                                                                                                <div class="mt-action-info ">
                                                                                                                    <div class="mt-action-icon ">
                                                                                                    ...
                                                                                                    <div class="mt-action">
                                                                                                        <div class="mt-action-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar2.jpg" /> </div>
                                                                                                        <div class="mt-action-body">
                                                                                                            <div class="mt-action-row">
                                                                                                                <div class="mt-action-info ">
                                                                                                                    <div class="mt-action-icon ">
                                                                                                    ...
                                                                                                    <div class="mt-action">
                                                                                                        <div class="mt-action-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar7.jpg" /> </div>
                                                                                                        <div class="mt-action-body">
                                                                                                            <div class="mt-action-row">
                                                                                                                <div class="mt-action-info ">
                                                                                                                    <div class="mt-action-icon ">
                                                                                                    ...
                                                                                                    <div class="mt-action">
                                                                                                        <div class="mt-action-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar9.jpg" /> </div>
                                                                                                        <div class="mt-action-body">
                                                                                                            <div class="mt-action-row">
                                                                                                                <div class="mt-action-info ">
                                                                                                                    <div class="mt-action-icon ">
                                                                                            ...
                                                                                            <div class="tab-pane" id="tab_actions_completed">
                                                                                                ...
                                                                                                <div class="mt-actions">
                                                                                                    ...
                                                                                                    <div class="mt-action">
                                                                                                        <div class="mt-action-img">
                                                                                                            <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar5.jpg" /> </div>
                                                                                                        <div class="mt-action-body">
                                                                                                            <div class="mt-action-row">
                                                                                                                <div class="mt-action-info ">
                                                                                                                    <div class="mt-action-icon ">
                                                                                            ...
                                                                                            <div class="events-content">
                                                                                                <ol>
                                                                                                    <li class="selected" data-date="16/01/2014">
                                                                                                        ...
                                                                                                        <div class="mt-author">
                                                                                                            <div class="mt-avatar">
                                                                                                                <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar80_3.jpg" />
                                                                                                            </div>
                                                                                                    ...
                                                                                                    <li data-date="20/04/2014">
                                                                                                        ...
                                                                                                        <div class="mt-author">
                                                                                                            <div class="mt-avatar">
                                                                                                                <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar80_1.jpg" />
                                                                                                            </div>
                                                                                                            <div class="mt-author-name">
                                                                                                    ...
                                                                                                    <li data-date="20/05/2014">
                                                                                                        ...
                                                                                                        <div class="mt-author">
                                                                                                            <div class="mt-avatar">
                                                                                                                <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar80_2.jpg" />
                                                                                                            </div>
                                                                                                            <div class="mt-author-name">
                                                                                                                <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
                                                                                                            </div>
                                                                                                    ...
                                                                                                    <li data-date="30/08/2014">
                                                                                                        ...
                                                                                                        <div class="clearfix"></div>
                                                                                                        <div class="mt-content border-grey-steel">
                                                                                                            <img class="timeline-body-img pull-left" src="<?php echo base_url(); ?>assets/admin/pages/media/blog/5.jpg" alt="">
                                                                                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                                                                                                qui ut. laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. </p>
                                                                                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                                                                                                qui ut. laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. </p>
                                                                                                    ...
                                                                                                    <li data-date="15/09/2014">
                                                                                                        ...
                                                                                                        <div class="mt-author">
                                                                                                            <div class="mt-avatar">
                                                                                                                <img src="<?php echo base_url(); ?>assets/admin/pages/media/users/avatar80_5.jpg" />
                                                                                                            </div>
                                                                                                            <div class="mt-author-name">
                                                                                                        ...
                                                                                                        <div class="clearfix"></div>
                                                                                                        <div class="mt-content border-grey-steel">
                                                                                                            <img class="timeline-body-img pull-right" src="<?php echo base_url(); ?>assets/admin/pages/media/blog/6.jpg" alt="">
                                                                                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                                                                                                qui ut.</p>
                                                                                    ...
                                                                                    <div class="portlet-body" id="chats">
                                                                                        <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                                                                                            <ul class="chats">
                                                                                                ...
                                                                                                <li class="in">
                                                                                                    <img class="avatar" alt="" src="<?php echo base_url(); ?>assets/admin/layouts/layout/img/avatar1.jpg" />
                                                                                                    <div class="message">
                                                                                                        <span class="arrow"> </span>
