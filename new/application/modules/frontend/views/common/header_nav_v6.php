...
<nav class="navbar navbar-expand-md navbar-light profi header">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav dashboard-menu">
            ...
            <li class="nav-item  <?php echo uri_string()==trim($row->page_url)?'active':''; ?>">
        ...
        <ul class="mynewmenu navbar-nav ml-auto dropdown show">
            ...
            <li class="stad"><?= $this->session->userdata('USER_NAME')?$this->session->userdata('USER_NAME'):'Welcome' ?></li>
