                            ...
                            <div class="card box-sec">
                                ...
                                <div class="card-body">
                                     <div class="row">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" value="<?php echo $user_deti['country']; ?>" readonly=""  name="country" placeholder="land">
                                        </div>

                                         <div class="col">
                                            <input type="text" class="form-control" value="<?php echo $user_deti['post_code'].' - '.$user_deti['city_name']; ?>" readonly=""  name="" placeholder="postCode/cityname">
                                        </div>
                                        
                                            <input type="hidden" readonly=""  value="<?php echo $user_deti['post_code']; ?>" name="postcode" id="postcode" placeholder="Postcode">
                                            <input type="hidden" class="form-control"  value="<?php echo $user_deti['post_code']; ?>" name="street" id="street" placeholder="Straat">
                                    </div>

                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control" name="number" id="number" placeholder="Straat + nr">
                                        </div>
                                        <div class="col">
                                ...
                                <div class="box-container text-center">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <ul>
                                            ...
                                            $getPriceDetailsInfo=getProductInfoPriceDetailsByPostcode($row->p_id,$this->session->userdata('USER_POSTCODE') );
                                            ?>
                                            ...
                                            <li><i class="fa fa-caret-right" aria-hidden="true"></i> Huurprijs/box: &#128; 
                                                <span class="box_prc_<?php echo  $row->p_id; ?>"><?php echo (isset($getPriceDetails['box_prc'])) ? number_format((float) $getPriceDetails['box_prc'], 2, ',', '') : number_format((float) 0, 2, ',', ''); ?>
                                                </span>
                                            ...
                                            <li> 
                                                <i class="fa fa-caret-right" aria-hidden="true"></i> Verlies/cup:  &#128; 
...
//            return false;
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url(); ?>frontend/product/populateCart",
