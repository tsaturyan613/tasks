                                    ...
                                    <table class="table table-striped table-inbox print-page mb-0" style="width:100%; border: 2px solid #3db8da;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="    line-height: 30px;text-align: right;"><?php echo $row->sort_desc ?></td>
                                                <td style="    line-height: 30px;text-align: right;"><?php echo $row->order_qty ?></td>
                                                <td style="    line-height: 30px;text-align: right;"> &#8364; <?php echo number_format((float) $row->order_time_max_rental_cost_per_product, 2, ',', ''); ?> </td>
                                                <td style="    line-height: 30px;text-align: right;">&#8364;<?php echo number_format((float) $row->order_time_max_wash_cost_per_product, 2, ',', ''); ?></td>
...
?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right;line-height: 30px;">&#8364;  <?php echo number_format(floatval($s_tot + ((21 / 100) * $s_tot)), 2, ',', '') ?></td>
                                            </tr>
                                            <tr>
                                                <td style="line-height: 30px;">Te betalen</td> 
                                                <td style="text-align: right;line-height: 30px;">&#8364;  <?php
                                                    $percentage = 60;
                                                    $totalWidth = number_format(floatval($s_tot + ((21 / 100) * $s_tot)), 2, ',', '');
                                                    if(!is_null($totalWidth)){

                                                        $to_paid = ($percentage / 100) * $totalWidth;
                                                        $to_be_paid=number_format(floatval($to_paid), 2, ',', '');
                                                        echo $to_be_paid;
                                                    }?>   
                                                </td>
                                            </tr>
