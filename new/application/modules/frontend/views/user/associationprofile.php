                ...
                <form name="registration" action="" method="post"  enctype="multipart/form-data" class="col-sm-12">
                    ...
                    <div class="card box-sec">
                        ...
                        <div class="card-body">     
                           <div class="row rowX">
                                <div class="col">
                                    <input type="text" class="form-control" value="<?php echo $query['country']; ?>" readonly="" required="" name="" placeholder="Stad">
                                </div>

                                 <div class="col">
                                    <input type="text" class="form-control" value="<?php echo $query['post_code'].' - '.$query['city_name']; ?>" readonly="" required="" name="" placeholder="Stad">
                                </div>

                                
                            </div>

                             <input type="hidden" class="form-control" value="<?php echo $query['city_name']; ?>" readonly="" required="" name="city_name" placeholder="Stad">
                             
                                    <input value="<?php echo $query['post_code']; ?>" readonly="" type="hidden" class="form-control" required="" id="postcode" name="postcode"  placeholder="Postcode">
