...
CKEDITOR.event||(CKEDITOR.event=function(){},CKEDITOR.event.implementOn=function(a){
    ...
    b.prototype={
        getListenerIndex:function(b){
            for(var a=0,d=this.listeners;a<d.length;a++)if(d[a].fn==b)return a;return-1
            }
        };
return{
    define:function(b,e){
...
(function(){
    ...
    CKEDITOR.tools={
        arrayCompare:function(b,a){
            ...
            for(var e=0;e<b.length;e++)if(b[e]!=a[e])return false;return true
            },
        clone:function(b){
            var a;
            ...
            a=new b.constructor;
            for(e in b)a[e]=CKEDITOR.tools.clone(b[e]);return a
            },
        ...
        isEmpty:function(b){
            for(var a in b)if(b.hasOwnProperty(a))return false;return true
            },
    ...
    buildStyleHtml:function(b){
        for(var b=[].concat(b),a,e=[],d=0;d<b.length;d++)if(a=b[d])/@import|[{}]/.test(a)?e.push("<style>"+a+"</style>"):e.push('<link type="text/css" rel=stylesheet href="'+a+'">');return e.join("")
        },
...
normalizeCssText:function(b,
    ...
    for(d in c)e.push(d+":"+c[d]);e.sort();
...
writeCssText:function(b,a){
    var e,c=[];
    for(e in b)c.push(e+":"+b[e]);a&&c.sort();
    return c.join("; ")
    },
objectCompare:function(b,a,c){
    ...
    if(!b&&!a)return true;
    if(!b||!a)return false;
    for(d in b)if(b[d]!=a[d])return false;if(!c)for(d in a)if(b[d]!=
        a[d])return false;return true
    },
objectKeys:function(b){
    var a=[],c;
    for(c in b)a.push(c);return a
    },
...
is:function(){
    ...
    for(var a=0;a<arguments.length;a++)if(arguments[a]==b)return true;return false
    },
...
setAttributes:function(b){
    for(var a in b)this.setAttribute(a,b[a]);return this
    },
setValue:function(b){
    this.$.value=b;
    return this
...
removeStyle:function(b){
    ...
    if(!a.removeProperty&&(b=="border"||b=="margin"||b=="padding")){
        ...
        for(var a=[],j=0;j<c.length;j++)if(d)for(var l=0;l<d.length;l++)a.push([b,c[j],d[l]].join("-"));else a.push([b,c[j]].join("-"));for(b=0;b<a.length;b++)this.removeStyle(a[b])
            }else{
...
setStyles:function(b){
    for(var a in b)this.setStyle(a,b[a]);return this
    },
...
j&&d.$.parentNode&&d.remove()
    ...
    u:1,
    "var":1
},j=CKEDITOR.dom.walker.bogus(),l=new CKEDITOR.dom.walker.whitespaces,i=new CKEDITOR.dom.walker.bookmark,m=/^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
...
function c(a,b,c){
    ...
    for(var d in b)c[d]||(c[d]=a(d,b[d]));return false
    }
    function b(a,b){
    if(!a)return false;
    if(a===true)return a;
    ...
    return b._.filterFunction=function(g,h,e,f,k,j,p){
        ...
        if(e=e&&e[o]){
            ...
            for(t in w)o[t]?D.push(t+":"+w[t]):z=true;if(D.length)r.style=D.sort().join("; ")
                }
                if(h.allClasses)q&&(r["class"]=q);
        else{
            for(t in e)e[t]&&s.push(t);s.length&&(r["class"]=s.sort().join(" "));
...
check:function(a,b,c){
    ...
    if(CKEDITOR.tools.isArray(a)){
        for(var h=a.length;h--;)if(this.check(a[h],b,c))return true;return false
        }
        var g,e;
    if(typeof a=="string"){
    ...
    if(typeof b=="string")a.name=b;
        ...
        for(g in h)if(g=="class"){
            ...
            for(k=h[g].split(/\s+/);f=k.pop();)c.indexOf(f)==-1&&a.classes.push(f)
                }else a.attributes[g]=h[g];for(e in d)a.styles[e]=d[e]
            }
        }
}
})();
...
(function(){
    ...
    var o={
    elements:{}
},p=c=="html",r=CKEDITOR.tools.extend({},z),u;
for(u in r)"#"in B[u]||delete r[u];for(u in r)o.elements[u]=h(p,a.config.fillEmptyBlocks!==false);o.root=h(p);
...
var F=/(?:&nbsp;|\xa0)$/,D="{cke_protected}",B=CKEDITOR.dtd,q=["caption","colgroup","col","thead","tfoot","tbody"],z=CKEDITOR.tools.extend({},B.$blockLimit,B.$block),s={
    elements:{},
...
(function(){
    ...
    writeHtml:function(b,c){
        ...
        b.openTag(e,j);
        for(l in j)d.push([l,j[l]]);b.sortAttributes&&d.sort(a);
        l=0;
...
function e(a){
    var c,g=a.getRanges()[0],a=a.root,d=g.startPath(),e={
        table:1,
        ul:1,
        ol:1,
        dl:1
    ...
    for(var c=this.editor,g=c.config.enterMode,
        ...
        if(!m.checkReadOnly()){
            ...
            if(k)for(;(q=m.getCommonAncestor(0,1))&&(z=CKEDITOR.dtd[q.getName()])&&(!z||!z[i]);)if(q.getName()in CKEDITOR.dtd.span)m.splitElement(q);
                ...
                m.collapse(true);
                q.remove()
                }else m.splitBlock(g==CKEDITOR.ENTER_DIV?"div":"p",c.editable());m.insertNode(n);
            l||
            (l=n)
            }
        }
...
selectRanges:function(a){
    if(a.length)if(this.isLocked){
        ...
        if(n){
            var c=CKEDITOR.dom.walker.whitespaces(true),e=/\ufeff|\u00a0/,i={
                table:1,
                tbody:1,
                tr:1
            };
    ...
    if(b.collapsed){
        ...
        if(!g){
            ...
            for(var g=u(this,c),r=g.hasAttributes(),t=n.getCommonAncestor(),q={},s={},v={},D={},B,z,F;g&&t;){
                if(t.getName()==d){
                    for(B in e.attributes)if(!D[B]&&(F=t.getAttribute(z)))g.getAttribute(B)==F?s[B]=1:D[B]=1;for(z in e.styles)if(!v[z]&&(F=t.getStyle(z)))g.getStyle(z)==F?q[z]=1:v[z]=1
                        }
                        t=t.getParent()
                }
                for(B in s)g.removeAttribute(B);for(z in q)g.removeStyle(z);r&&!g.hasAttributes()&&(g=
                null);
            if(g){
...
function b(a){
    ...
    for(f=0;;f++){
        i=d.elements[f];
        if(i.equals(e))break;
        else if(i.match)continue;else i=i.clone();
        i.append(h);
        h=i
        }
...
function f(a){
    ...
    if(a=(new CKEDITOR.dom.elementPath(b,a.root)).contains(this.element,1)){
        ...
        c=b.attributes;
        if(c)for(var e in c)a.removeAttribute(e,c[e]);if(b.styles)for(var d in b.styles)b.styles.hasOwnProperty(d)&&a.removeStyle(d)
            }
        }
function d(a){
    ...
    for(var e;e=c.getNextParagraph();)if(this.checkElementRemovable(e))if(e.is("pre")){
        ...
        l(e,d)
        }else r.call(this,e);a.moveToBookmark(b)
    }
    function l(a,b){
    var c=!b;
    if(c){
...
function F(a,
    ...
    audio:1,
    video:1
},z=/\s*(?:;\s*|$)/,s=/#\((.+?)\)/g,A=CKEDITOR.dom.walker.bookmark(0,1),v=CKEDITOR.dom.walker.whitespaces(1);
...
(function(){
    var a={},c;
    for(c in CKEDITOR.dtd.$blockLimit)c in CKEDITOR.dtd.$list||(a[c]=1);var b={};
    
    for(c in CKEDITOR.dtd.$block)c in CKEDITOR.dtd.$blockLimit||c in CKEDITOR.dtd.$empty||(b[c]=1);CKEDITOR.dom.elementPath=function(c,e){
...
CKEDITOR.dom.elementPath.prototype={
    compare:function(a){
        ...
        for(var b=0;b<c.length;b++)if(!c[b].equals(a[b]))return false;return true
        },
...
CKEDITOR.ui.dialog.uiElement.prototype={
    ...
    registerEvents:function(a){
        ...
        for(d in a)if(c=d.match(b))this.eventProcessors[d]?this.eventProcessors[d].call(this,this._.dialog,a[d]):e(this,this._.dialog,c[1].toLowerCase(),a[d]);return this
        },
    eventProcessors:{
        onLoad:function(a,b){
            a.on("load",b,this)
        ...
        var d,i=function(c,h){
            ...
            switch(h){
                case 9:case CKEDITOR.SHIFT+9:
                    for(;!b||!b.items.length;)if(b=9==h?(b?b.next:c.toolbar.next)||a.toolbox.toolbars[0]:(b?b.previous:c.toolbar.previous)||a.toolbox.toolbars[a.toolbox.toolbars.length-1],b.items.length)for(c=b.items[d?b.items.length-1:0];c&&!c.focus;)(c=d?c.previous:c.next)||(b=0);c&&c.focus();
                    return!1;
                case e?37:
                    39:case 40:
                    b=c;
...
(function(){
    ...
    c,d){
    if(-1!==d.indexOf(";")){
        for(var d=d.split(";"),b=0;b<d.length;b++)if(h(a,c,d[b]))return!0;return!1
        }
...
(function(){
    ...
    for(var g=new CKEDITOR.dom.walker(b),d;d=g.next();)if(d.type==CKEDITOR.NODE_ELEMENT)if(!d.equals(a.data.node)&&d.getDirection())b.setStartAfter(d),g=new CKEDITOR.dom.walker(b);
        else{
